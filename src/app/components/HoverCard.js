export default function HoverCard({url, p1,p2}) {
  ...
  <div className='grid place-items-center w-full h-full absolute top-0 left-0 opacity-0 group-hover:opacity-100 z-20'>
      <p className=' text-white p-20 text-2xl lg:text-md font-bold'>{p2}</p>
  </div>
</div>
